...
#
ADDR="http://localhost:4440/api/15/project/" + PROJECT + "/scm/import/action/import-jobs/input"
resp=requests.get(ADDR, headers={'Accept': 'application/json', 'X-Rundeck-Auth-Token': TOKEN, 'Content-Type': 'application/json'})
jsonobj=resp.json()
items=[]
